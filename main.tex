...
\siglalista{URLs}{\textit{Uniform Resource Locators}}
\siglalista{RFID}{\textit{Radio Frequency Identification}}
\siglalista{MVP}{\textit{Minimum Viable Product}}
\siglalista{SaaS}{\textit{Software as a Service}}
\siglalista{OAuth}{\textit{Open Authorization}}
\siglalista{CRM}{\textit{Customer Relationship Management}}
\siglalista{AWS}{\textit{Amazon Web Services}}
\siglalista{S3}{\textit{Simple Storage Service}}
\siglalista{EC2}{\textit{Elastic Compute Cloud}}
\siglalista{PFC}{\textit{Projeto de Fim de Curso}}
...
% 4.5 - Capítulo 4.5
% ---
\include{chapters/4_5-chapter_tecnologies}
% ---
